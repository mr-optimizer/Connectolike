...
const Hero = () => {
    ...
    const [text] = useTypewriter({
        words: ['Who thinks like you!','Who code like you!','Who chill like you!'],
        loop: 0
    });
    ...
    return (
        <div className="hero">
            <div className="hero__texts">
                ...
                <button className="u-margin-top-medium hero__texts__btn" onClick={clickHandler} >Get your companion</button>
            </div>
